...
export default function page() {
  return (
    <BackgroundContainer backgroundImage="/images/reflections.gif" opacity={0.5}>
      <h1 className="py-6 text-5xl/8 text-center subpixel-antialiased">
        Origin Story
      </h1>
      <p className="text-xl/6 p-4 subpixel-antialiased">
      ...
      <p className="text-xl/6 p-4 subpixel-antialiasedd">
